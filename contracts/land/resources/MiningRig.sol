...
import { IMiningRig } from "./IMiningRig.sol";
 ...
 */
contract MiningRig is IMiningRig, Ownable, ERC721VotesC, BasicRoyalties{
    ...
    mapping(uint256 => RigAttributes) public rigAttributes;
