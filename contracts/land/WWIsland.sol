...
contract WWIsland is Ownable, ERC721, ERC721URIStorage {
    ...
    constructor(string memory name, string memory symbol, bytes32 merkleRoot, string memory _contractURI) ERC721(name, symbol) Ownable(msg.sender){
        root = merkleRoot;
